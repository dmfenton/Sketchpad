          ...
          <div className="about-layout">
            <div className="about-visual">
              <div className="artist-avatar">
                <svg viewBox="0 0 120 120" className="avatar-svg">
                  ...
                  <circle cx="60" cy="60" r="55" fill="none" stroke="url(#avatarGradient)" strokeWidth="2" />
                  <circle cx="60" cy="60" r="45" fill="url(#avatarGradient)" opacity="0.1" />
                  {/* Abstract face/brush representation */}
                  <path
            ...
            <div className="about-text">
              ...
              <p className="about-intro">
                Code Monet is an autonomous AI artist powered by Claude, Anthropic&apos;s most capable model.
              </p>
              <p>
                Unlike typical AI art tools that generate images from prompts, Code Monet operates
                independently — deciding what to create, when to create it, and how each piece should
                evolve. It writes actual drawing code, executing brushstrokes one at a time while
                sharing its creative reasoning in real-time.
              </p>
              <p>
                The artist maintains persistent memory across sessions, developing artistic preferences
                and building on previous work. Each piece is genuinely novel — not retrieved from a
                database, but conceived and executed in the moment.
              </p>
        ...
        <div className="section-content">
          <div className="about-layout reverse">
            <div className="about-text">
              ...
              <p className="about-intro">
                Built by Daniel Fenton, a software engineer exploring the boundaries of AI creativity.
              </p>
              <p>
              ...
              <p>
                The project is built with the Claude Agent SDK, FastAPI, React Native, and a lot
                of curiosity about where human and machine creativity intersect.
              </p>
              <div className="creator-links">
                <a href="https://github.com/dmfenton" target="_blank" rel="noopener noreferrer" className="creator-link">
                ...
                <a href="https://linkedin.com/in/dmfenton" target="_blank" rel="noopener noreferrer" className="creator-link">
                  <svg viewBox="0 0 24 24" fill="currentColor">
